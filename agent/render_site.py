...
.modal h3 .icon-sm { display: inline-flex; width: 20px; height: 20px; vertical-align: -3px; margin-right: 6px; color: var(--text-soft); }
...
_SVG_ICONS = {
    "ai":           '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><circle cx="5" cy="6" r="1.5"/><circle cx="19" cy="6" r="1.5"/><circle cx="5" cy="18" r="1.5"/><circle cx="19" cy="18" r="1.5"/><line x1="6.3" y1="6.8" x2="9.5" y2="10.5"/><line x1="17.7" y1="6.8" x2="14.5" y2="10.5"/><line x1="6.3" y1="17.2" x2="9.5" y2="13.5"/><line x1="17.7" y1="17.2" x2="14.5" y2="13.5"/></svg>',
    "robot":        '<svg viewBox="0 0 24 24"><rect x="5" y="7" width="14" height="12" rx="2"/><circle cx="9" cy="13" r="1"/><circle cx="15" cy="13" r="1"/><line x1="12" y1="3" x2="12" y2="7"/><circle cx="12" cy="3" r="1"/><line x1="2" y1="14" x2="5" y2="14"/><line x1="19" y1="14" x2="22" y2="14"/></svg>',
...
<nav class="nav">
  <div class="nav-inner">
    ...
    <!-- 顶部导航不再展示领域 chip（避免重复 + 同步问题）；点 brand 回首页用卡片选 -->
    <div class="nav-links" style="display:none">{nav_html}</div>
